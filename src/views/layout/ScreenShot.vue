...
<!--    <n-button class="save" type="primary" @click="save">保存</n-button>-->
<!--    <n-button class="close" type="warning" @click="close">退出</n-button>-->
    <n-icon class="save" :component="SaveOutline" size="25" :depth="5" color="black" @click="save" />
    <n-icon class="close" :component="ExitOutline" size="30" :depth="5" color="black" @click="close" />
  </div>
</template>
...
import { ExitOutline,SaveOutline } from '@vicons/ionicons5'
import ImageEditor from 'tui-image-editor'
import {ref, onMounted, watch, onUnmounted} from "vue";
import {screenShot} from "@/views/business/practice/components/maptools";
...
const getimage = () => {
  screenShot()
  data = window.localStorage.getItem('image')
